using Cordial.Mods.BoosterJuice.Scripts;
using System;
                                                      ...
                                                      IFinishedStateListener
{
    ...
    public void Awake()
    {
        ...
        this.DisableComponent();  // start disabled


    }

    public void OnEnterFinishedState() => this.EnableComponent();
    public void OnExitFinishedState() => this.DisableComponent();
